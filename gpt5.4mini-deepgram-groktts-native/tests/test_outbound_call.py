...
2. Full outbound call cycle: place real call, record, transcribe, verify greeting

Requirements:
    - Valid PLIVO_AUTH_ID, PLIVO_AUTH_TOKEN, PLIVO_PHONE_NUMBER, PLIVO_TEST_NUMBER,
      OPENAI_API_KEY, XAI_API_KEY, DEEPGRAM_API_KEY in .env
...
Usage:
    cd gpt5.4mini-deepgram-groktts-native
...
pytestmark = pytest.mark.skipif(
    not all([
        ...
        PLIVO_TEST_NUMBER, OPENAI_API_KEY, XAI_API_KEY, DEEPGRAM_API_KEY,
    ]),
...
def bleg_app_id(plivo_client, ngrok_tunnel):
    ...
    app_name = "GPT54Mini_Deepgram_GrokTTS_Outbound_Test_Agent"
