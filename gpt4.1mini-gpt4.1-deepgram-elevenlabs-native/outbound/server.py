...
app = FastAPI(
    title="Dual-LLM Lead Qualification Voice Agent (Outbound)",
    description=(
        "Outbound voice agent: GPT-4.1 mini (conversation) + GPT-4.1 (reasoning) "
...
async def health_check() -> dict:
    ...
    return {
        "status": "ok",
        "service": "gpt4.1mini-gpt4.1-deepgram-elevenlabs-voice-agent-outbound",
