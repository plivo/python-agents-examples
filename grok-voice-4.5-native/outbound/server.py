...
app = FastAPI(
    title="xAI Realtime-Plivo Voice Agent (Outbound)",
    description="Outbound voice agent using the xAI realtime API with Plivo telephony",
    version="0.1.0",
)
...
async def health_check() -> dict:
    ...
    return {
        "status": "ok",
        "service": "xai-realtime-plivo-voice-agent-outbound",
...
def main() -> None:
    ...
    logger.info(f"Starting xAI Realtime-Plivo Outbound Voice Agent on port {SERVER_PORT}")
