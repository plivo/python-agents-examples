...
app = FastAPI(
    title="GPT-4.1 Mini + Sarvam + ElevenLabs Voice Agent (Outbound)",
    description="Outbound voice agent: GPT-4.1 mini + Sarvam STT + ElevenLabs TTS + Plivo",
    version="0.1.0",
)
...
async def health_check() -> dict:
    ...
    return {
        "status": "ok",
        "service": "gpt4.1mini-sarvam-elevenlabs-voice-agent-outbound",
