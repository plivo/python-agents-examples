"""
End-to-end live tests for the Gemini 3.1 Flash Live voice agent.
...
class TestE2ELive:
    ...
    @pytest.mark.asyncio
    @pytest.mark.skip(
        reason="Gemini 3.1 Live API: send_realtime_input(text=...) does not trigger "
        "model response mid-conversation — automatic activity detection only "
        "responds to audio input. Text injection is a test convenience; "
        "real calls use audio."
    )
