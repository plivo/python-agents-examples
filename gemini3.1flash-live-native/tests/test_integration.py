"""
Integration tests for Gemini 3.1 Flash Live Voice Agent.
...
class TestGeminiIntegration:
    """Integration tests for Gemini 3.1 Flash Live API."""
...
class TestPlivoIntegration:
    ...
    def test_plivo_credentials_valid(self, plivo_configured):
        ...
        import plivo as plivo_mod

        client = plivo_mod.RestClient(auth_id=PLIVO_AUTH_ID, auth_token=PLIVO_AUTH_TOKEN)
    ...
    def test_plivo_phone_number_exists(self, plivo_configured):
        ...
        except plivo_mod.exceptions.ResourceNotFoundError:
