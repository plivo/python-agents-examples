...
app = FastAPI(
    ...
    description="Inbound voice agent using Google Gemini Live API with Plivo telephony",
    version="0.1.0",
)
...
async def health_check() -> dict:
    ...
    return {
        "status": "ok",
        "service": "gemini-plivo-voice-agent-inbound",
...
def main() -> None:
    ...
    logger.info(f"Starting Gemini-Plivo Inbound Voice Agent on port {SERVER_PORT}")
