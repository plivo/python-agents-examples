...
A voice agent that uses Google Gemini for conversation, Deepgram for speech-to-text, and Cartesia for text-to-speech. This implementation uses direct API integration without any orchestration frameworks.
...
4. Response text sent to Cartesia for speech synthesis
...
- **Cartesia**: Linear PCM 16-bit 24kHz
...
5. Gemini response is synthesized via Cartesia
