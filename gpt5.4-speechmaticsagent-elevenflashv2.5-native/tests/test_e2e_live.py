"""
End-to-end live tests for the GPT-5.4 Mini + Speechmatics + ElevenLabs voice agent.
...
Requirements:
    - Valid OPENAI_API_KEY, SPEECHMATICS_API_KEY, ELEVENLABS_API_KEY in .env
...
pytestmark = pytest.mark.skipif(
    not all([OPENAI_API_KEY, ELEVENLABS_API_KEY]),
    reason="OPENAI_API_KEY or ELEVENLABS_API_KEY not configured",
)
