...
class TestHealthCheck:
    ...
    async def test_health_check(self):
        ...
        assert data["service"] == "gemini-deepgram-elevenlabs-voice-agent"
        assert "components" in data
        assert data["components"]["llm"]["provider"] == "google"
        assert data["components"]["stt"]["provider"] == "deepgram"
        assert data["components"]["tts"]["provider"] == "elevenlabs"
        assert data["components"]["telephony"] == "plivo"
        assert data["components"]["framework"] == "native"
